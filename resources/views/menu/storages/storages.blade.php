                ...
                <div class="center-content">
                    <div class="content__inputs">
                        ...
                        <a href="{{ url('storages/create') }}">
                            <input type="submit" class="inputs__buttom" value="CREAR ALMACEN">
                        </a>
                    </div>
                    ...
                    <div class="content__data">
                        <table class="products__table">
                            <thead class="table__th">
                                <tr>
                                    <th class="th__title">Id Almacen</th>
                                    <th class="th__title">Nombre Almacen</th>
                                    <th class="th__title">Dirección</th>
                                    <th class="th__title">Encargado</th>
                            ...
                            <tbody class="table__td">
                                ...
                                <tr>
                                    <td class="td__data supplier-id">{{ $stores->store_id }}</td>
                                    <td class="td__data supplier-name">{{ $stores->name_store }}</td>
                                    <td class="td__data supplier-email">{{ $stores->address_store }}</td>
                                    <td class="td__data supplier-city">{{ $stores->incharge_store }}</td>
                                    <td class="td__data supplier-phone">{{ $stores->phone }}</td>
                                    <td class="td__data supplier-buttoms">
                                        <a href="{{ url('/storages/'.$stores->store_id.'/edit') }}">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <form action="{{ url('/storages/'.$stores->store_id) }}" class="d-inline" method="post">
                                            @csrf
                                            {{ method_field('DELETE') }}
