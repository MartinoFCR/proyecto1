...
<body>
    <div class="layout">
        ...
        <div class="layout__content">
            ...
            <h3 class="content__info">Almacen / Almacenes</h3>

            <div class="center-content">
                <div class="content__data">
                    <form action="{{ url('/storages') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @include('menu/storages/form_storage', ['modo'=>'Crear'])
                    </form>
                </div>
            </div>
        </div>
