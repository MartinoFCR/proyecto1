                    ...
                    <div class="content__data">
                        ...
                        <table class="products__table">
                            ...
                            <tbody class="table__td">
                                ...
                                <tr>
                                    <td class="td__data clients-id">{{ $employee->employees_id }}</td>
                                    <td class="td__data clients-name">{{ $employee->name_employees }}</td>
                                    <td class="td__data clients-lastname">{{ $employee->lastname_employees }}</td>
                                    <td class="td__data clients-date">{{ $employee->date }}</td>
                                    <td class="td__data clients-date">{{ $employee->email }}</td>
                                    <td class="td__data clients-buttoms">
                                        <a href="{{ url('employees/'.$employee->employees_id.'/edit') }}">
